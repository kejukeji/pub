...
api.add_resource(ClearMessageInfo, '/restful/user/clear/message/info')
...
api.add_resource(PersonalPrivateLetter, '/restful/personal/private/letter')
api.add_resource(CreditRule, '/restful/credit/rule')
