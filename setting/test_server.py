...
SERVER_NAME = 'pub.app:5001'

# models模块需要的配置参数
# ===============================================================
SQLALCHEMY_DATABASE_URI = 'mysql://root:root@127.0.0.1:3306/maobake_pub?charset=utf8'  # 连接的数据库
...
HEAD_PICTURE_BASE_PATH = '/var/www/pub'  # pub运行文件的目录，图片的绝对路径使用
...
PUB_PICTURE_BASE_PATH = '/var/www/pub'  # pub运行文件的目录，图片的绝对路径使用
